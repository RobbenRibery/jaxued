...
def sample_trajectories_and_learn(
    ...
    all_rollouts = jax.tree_util.tree_map(
        lambda x: jnp.concatenate(x, axis=0), all_rollouts
    )
...
def main(config=None, project="JAXUED_TEST"):
    ...
    def log_eval(stats, train_state_info):
        ...
        log_dict.update({"animations/animation": wandb.Video(frames, fps=4)})
    ...
    def eval_checkpoint(og_config):
        ...
        states, cum_rewards, episode_lengths = jax.vmap(eval, (0, None, None))(
